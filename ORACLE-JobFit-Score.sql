...
CREATE OR REPLACE PACKAGE pkg_insertDados AS
    ...
    PROCEDURE sp_inserir_empresa(p_nome IN VARCHAR2, p_cnpj IN VARCHAR2, p_id_empresa OUT NUMBER);
...
CREATE OR REPLACE PACKAGE BODY pkg_insertDados AS
    ...
    PROCEDURE sp_inserir_empresa(p_nome IN VARCHAR2, p_cnpj IN VARCHAR2, p_id_empresa OUT NUMBER) AS
    BEGIN
...
DECLARE
    v_id NUMBER;
BEGIN
    pkg_insertDados.sp_inserir_usuario('Ana Paula Santos', 'ana.santos@email.com', 'senha123', v_id);
    pkg_insertDados.sp_inserir_usuario('Carlos Eduardo Lima', 'carlos.lima@email.com', 'senha123', v_id);
    pkg_insertDados.sp_inserir_usuario('Mariana Costa Silva', 'mariana.costa@email.com', 'senha123', v_id);
    pkg_insertDados.sp_inserir_usuario('Ricardo Almeida', 'ricardo.almeida@email.com', 'senha123', v_id);
    pkg_insertDados.sp_inserir_usuario('Juliana Ferreira', 'juliana.ferreira@email.com', 'senha123', v_id);
    pkg_insertDados.sp_inserir_usuario('Fernando Oliveira', 'fernando.oliveira@email.com', 'senha123', v_id);
    pkg_insertDados.sp_inserir_usuario('Beatriz Rodrigues', 'beatriz.rodrigues@email.com', 'senha123', v_id);
    pkg_insertDados.sp_inserir_usuario('Paulo Henrique Souza', 'paulo.souza@email.com', 'senha123', v_id);
    pkg_insertDados.sp_inserir_usuario('Camila Martins', 'camila.martins@email.com', 'senha123', v_id);
    pkg_insertDados.sp_inserir_usuario('Gabriel Pereira', 'gabriel.pereira@email.com', 'senha123', v_id);
...
DECLARE
    v_id NUMBER;
BEGIN
    pkg_insertDados.sp_inserir_empresa('Tech Solutions Brasil', '12345678000190', v_id);
    pkg_insertDados.sp_inserir_empresa('Inovação Digital Ltda', '98765432000145', v_id);
    pkg_insertDados.sp_inserir_empresa('Consultoria TI Express', '11223344000156', v_id);
    pkg_insertDados.sp_inserir_empresa('Desenvolve Software SA', '55667788000198', v_id);
    pkg_insertDados.sp_inserir_empresa('Cloud Computing Brasil', '99887766000132', v_id);
    pkg_insertDados.sp_inserir_empresa('Data Science Corp', '44556677000178', v_id);
    pkg_insertDados.sp_inserir_empresa('Agile Developers', '33221100000165', v_id);
    pkg_insertDados.sp_inserir_empresa('Web Solutions Pro', '77889900000123', v_id);
    pkg_insertDados.sp_inserir_empresa('Mobile Apps Brasil', '66554433000187', v_id);
    pkg_insertDados.sp_inserir_empresa('Cyber Security Tech', '22334455000141', v_id);
